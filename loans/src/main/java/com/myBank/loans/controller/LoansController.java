...
import com.myBank.loans.dto.LoanContactInfoDto;
...
public class LoansController {
    ...
    @Operation(
            ...
            description = "Get build version information that is deployed into loans microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Contact Info details that can be reached out in case of any issues in loans microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
